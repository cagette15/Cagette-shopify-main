...
export default function MobileMenu({ menu }: { menu: SimpleMenuItem[] }) {
  ...
  return (
    <>
      ...
      >
        <MenuIcon className="h-7 w-7 text-black transition-all ease-in-out hover:scale-110 hover:text-gray-500" />
      </button>
