        ...
        >
          ...
          <div className="fixed inset-0 flex justify-end" data-testid="cart">
            <Dialog.Panel
              ...
              className="flex w-full flex-col bg-white p-8 text-black  text-second md:w-3/5 lg:w-2/5"
            >
              ...
              {cart.lines.length !== 0 ? (
                <div className="flex h-full flex-col justify-between overflow-hidden">
                      ...
                      return (
                        <li key={i} data-testid="cart-item">
                          ...
                          <div className="flex h-9 flex-row">
                            ...
                            <p className="ml-2 flex w-full items-center justify-center border border-second border-opacity-50">
                  ...
                  <a
                    ...
                    className="flex w-full items-center justify-center bg-second p-3 text-sm font-medium uppercase text-white opacity-100 hover:opacity-90 "
                  >
