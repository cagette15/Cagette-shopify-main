...
export default function SignupPage() {
  ...
  async function onSubmit(ev: FormEvent<HTMLFormElement>) {
    ...
    const parsed = SignupFormSchema.safeParse(extractedData);
    ...
    if (!parsed.success) {
      ...
      if (firstErrorKey !== undefined) {
        const firstErrorMessage =
          fieldErrors[firstErrorKey as keyof typeof fieldErrors]?.[0] || 'An error occurred';
    ...
    <section className="flex items-stretch text-white md:min-h-[90vh] ">
      ...
      <div className="z-0 flex w-full items-center justify-center bg-black/95 px-0 text-center md:bg-cagette md:px-16 lg:w-1/2">
        ...
        <div className="z-20 w-full py-6 pt-20 md:pt-0">
          ...
          <form
            method="post"
            action="/api/accounts/signup"
            onSubmit={onSubmit}
            className="mx-auto w-full px-4 sm:w-2/3 lg:px-0"
          >
            <div className="pb-2 pt-4 text-gray-800">
              <input
                type="text"
                name="firstName"
                id="firstName"
            ...
            <div className=" px-4 py-2  font-medium text-gray-100 hover:text-[#95112c] md:text-gray-600">
              <div>
